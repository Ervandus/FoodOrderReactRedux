...
let initialState = {
    inventory: [
        {fooditem: "Soup", price: 3.50},
        {fooditem: "Salad Olivie", price: 3.50},
        {fooditem: "Salad Shuba", price: 3.50},
        {fooditem: "Buckwheat with beef", price: 6.50},
        {fooditem: "Risotto", price: 6.50},
        {fooditem: "Fish burgers", price: 6.00}
    ],
    cart: [],
    total: [{totalvalue:0}]
};
